...
@section('title', "Просмотр сервиса id {$service->id}")

@section('content')

    <div class="container mx-auto px-6 py-8">
        <h3 class="text-gray-700 text-3xl font-medium">{{ "Просмотр сервиса id {$service->id}" }}</h3>
                ...
                <div
                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">{{ $service->description }}</div>
                            </td>
