...
@section('title', "Просмотр О Нас id {$about->id}")

@section('content')

    <div class="container mx-auto px-6 py-8">
        <h3 class="text-gray-700 text-3xl font-medium">{{ "Просмотр О Нас id {$about->id}" }}</h3>
                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">{{ $about->title }}</div>
                            </td>

                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">{{ $about->description }}</div>
                            </td>
